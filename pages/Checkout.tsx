...
import { useLanguage } from '../context/LanguageContext'; // <--- (1) تم إضافة الاستيراد هنا
...
export default function Checkout() {
  ...
  const { user } = useAuth();
  const { lang } = useLanguage(); // <--- (2) استخدام اللغة هنا
  ...
  const t = {
    ...
    note: lang === 'ar' ? 'بالضغط على التحميل، يتم إنشاء ملف PDF عالي الدقة.' : 'Clicking download generates a high-quality PDF.',
    ...
    <div className="min-h-screen bg-[#F8FAFC] pt-32 pb-12 px-4" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* العمود الجانبي: الملخص والإجراءات */}
